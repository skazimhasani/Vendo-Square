  ...
  return (
    <div className="dark:bg-slate-600 bg-slate-50 shadow-xl p-8 rounded-lg">
      ...
      <div className="p-4">
        ...
        <div
          className="text-sm font-medium text-center text-gray-200 border-b
                  ...
                  <button
                    ...
                    className={
                      chartToDisplay == tab.type
                        ...
                        : "inline-block p-4 border-b-2 border-transparent text-black rounded-t-lg hover:text-gray-300 hover:border-gray-700 dark:hover:text-gray-100"
                    }
                  >
                    {tab.title}
                  </button>
